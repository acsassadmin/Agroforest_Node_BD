...
// --- Types Routes ---
router.get(
  "/production-center-types/",
  authenticateToken,
  prodController.getProductionCenterTypes,
);
router.post(
  "/production-center-types/",
  authenticateToken,
  prodController.createProductionCenterType,
);
router.put(
  "/production-center-types/",
  authenticateToken,
  prodController.updateProductionCenterType,
);
router.delete(
  "/production-center-types/",
  authenticateToken,
  prodController.deleteProductionCenterType,
);
...
router.get(
  "/production-centers/",
  authenticateToken,
  prodController.getProductionCenters,
);
router.post(
  "/production-centers/",
  authenticateToken,
  prodController.uploadMiddleware,
  prodController.createProductionCenter,
);
router.put(
  "/production-centers/",
  authenticateToken,
  prodController.uploadMiddleware,
  prodController.updateProductionCenter,
);
router.delete(
  "/production-centers/",
  authenticateToken,
...
router.get(
  "/productioncenter-summary",
  prodController.getProductionCenterSummary,
);
router.get("/department-summary/", prodController.getDepartmentSummary);
// sapling report
router.get(
  "/district-sapling-summary/",
  prodController.getDistrictSaplingSummary,
);
router.get("/block-sapling-summary/", prodController.getBlockSaplingSummary);
router.get(
  "/productioncenter-sapling-summary/",
  prodController.getProductionCenterSaplingSummary,
);
...
router.get(
  "/distribution-centers/",
  authenticateToken,
  distController.getDistributionCenters,
);
router.post(
  "/distribution-centers/",
  authenticateToken,
  distController.createDistributionCenter,
);
router.put(
  "/distribution-centers/",
  authenticateToken,
  distController.updateDistributionCenter,
);
router.delete(
  "/distribution-centers/",
  authenticateToken,
  distController.deleteDistributionCenter,
);
...
router.post(
  "/stock-details/",
  authenticateToken,
  stockController.uploadMiddleware,
  stockController.createStockDetail,
);
router.put(
  "/stock-details/",
  authenticateToken,
  stockController.uploadMiddleware,
  stockController.updateStockDetail,
);
router.delete(
  "/stock-details/",
  authenticateToken,
  stockController.deleteStockDetail,
);
...
router.get(
  "/stock-requests/",
  authenticateToken,
  stockController.getStockRequests,
);
router.post(
  "/stock-requests/",
  authenticateToken,
...
router.put(
  "/stock-requests/",
  authenticateToken,
  stockController.handleStockRequest,
);

// Excel & Dashboard
router.get(
  "/production-centers/excel/",
  authenticateToken,
  stockController.downloadExcel,
);
router.get(
  "/dashboard-summary/",
  authenticateToken,
  stockController.getDashboardSummary,
);
...
router.get(
  "/productioncenter-scheme/",
  productionschemaController.getProductionSchemes,
);
router.post(
  "/productioncenter-scheme/",
  productionschemaController.createProductionScheme,
);
router.put(
  "/productioncenter-scheme/:id",
  productionschemaController.updateProductionScheme,
);
router.delete(
  "/productioncenter-scheme/:id",
  productionschemaController.deleteProductionScheme,
);
