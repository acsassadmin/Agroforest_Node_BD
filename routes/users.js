...
router.get(
  "/farmer-request/",
  authenticateToken,
  userController.getCenterOrders,
);
...
router.put(
  "/request-header/:id",
  authenticateToken,
  userController.updateRequestHeader,
);
router.post("/order-placed/", authenticateToken, userController.orderPlaced);
router.get(
  "/farmer-request-items/",
  userController.getFarmerRequestItemByStockId,
);

router.get(
  "/dashboard/top-centers",
  authenticateToken,
  userController.getTopProductionCenters,
);
router.get(
  "/dashboard/district-saplings",
  authenticateToken,
  userController.getSaplingsDistrictWise,
);
router.get(
  "/production-centers/map",
  authenticateToken,
  userController.getProductionCentersForMap,
);
...
router.get(
  "/farmer-request-weekly-report/",
  authenticateToken,
  userController.getWeeklyFarmerRequestReport,
);
router.get(
  "/production-centers",
  authenticateToken,
  userController.getProductionCentersList,
);
router.get(
  "/target-details/",
  authenticateToken,
  userController.getTargetDetails,
);
router.get(
  "/farmer-details/",
  authenticateToken,
  userController.getFarmerDetails,
);
...
router.get(
  "/production-counts/",
  authenticateToken,
  userController.getProductionCenterStats,
);
router.get(
  "/production-saplings/",
  authenticateToken,
  userController.getProductionCenterSaplings,
);
router.get(
  "/production-monthly-sales/",
  authenticateToken,
  userController.getMonthlyTotalSales,
);
