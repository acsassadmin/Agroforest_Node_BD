...
router.get(
  "/get-formers-orders/:userid/:role",
  officerController.getFarmerOrders,
);
...
router.post(
  "/upload-inspection-sappling",
  upload.single("image"),
  officerController.uploadInspectionDetails,
);
...
router.get(
  "/get-producion-center/:userid/:role",
  officerController.getProductionCenters,
);
